...
for(i in 1:numofsimupc){
	...
	if(i==1){
		...
		res_second = third_FPC_conditional_2d_image(beta1, pc_index=i, sobserved,timepoints1,timepoints2,basis1,basis2, betalist =previous_beta , threshold=1e-5,minit=1)
